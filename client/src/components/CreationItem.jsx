...
const CreationItem = ({item}) => {
    const [expanded , setExpnanded] = useState(false)
  return (
    <div onClick={()=> setExpnanded(!expanded)} className='p-4 max-w-5xl text-sm bg-white border border-gray-200 rounded-lg cursor-pointer'>
